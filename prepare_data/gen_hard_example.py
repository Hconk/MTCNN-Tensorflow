...
def save_hard_example(net, data,save_path):
    ...
    # save files
    neg_label_file = "./DATA/LM%d/neg_%d.txt" % (net, image_size)
    neg_file = open(neg_label_file, 'w')

    pos_label_file = "./DATA/LM%d/pos_%d.txt" % (net, image_size)
    pos_file = open(pos_label_file, 'w')

    part_label_file = "./DATA/LM%d/part_%d.txt" % (net, image_size)
...
def t_net(prefix, epoch,
    ...
    basedir = './DATA/'
    #anno_file
    filename = './prepare_data/wider_face_train_bbx_gt.txt'
...
if __name__ == '__main__':
    ...
    data_dir = './DATA/LM%s' % str(image_size)
